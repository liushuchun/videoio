...
int DoFrameExport(char*  pInputURL, float fSeekPointPercnet, int  iDstWidth, int iDstHeight, enum AVPixelFormat  eDstPixelFmt, int iFrameCount, serialize_params*& ppsFramesOutput, int iMaxOutputSize, char* pExtra, int iInterval);
int ConvVideoPacket(AVFrame*  pAVFrame, int iTargetWidth, int iTargetHeight, enum AVPixelFormat  eDstPixelFmt, struct SwsContext*  pSws_ctx, char*& psFramesOutput, int iFrameIndex);
#endif
